    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h3 class="text-lg font-bold mb-4">Crear Curso</h3>
                ...
                <form action="{{ route('courses.store') }}" method="POST">
                    ...
                    <div class="flex items-center justify-start mt-6">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Guardar Curso</button>
                        <a href="{{ route('courses.index') }}" class="ml-4 inline-block align-baseline font-bold text-sm text-gray-600 hover:text-gray-800">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
